...
public static class Data
{
        ...
        new Dictionary<Tetromino, Vector2Int[]>()
    {
        ...
        // Fork Tetromino piece (6 blocks)
        { Tetromino.Fork, new Vector2Int[]
            {
                new Vector2Int(0,1),   
                new Vector2Int(-1,0),  
                new Vector2Int(0,0),   
    ...
    private static readonly Vector2Int[,] WallKicksFork = WallKicksJLOSTZ;
